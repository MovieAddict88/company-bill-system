<?php
        ...
        */
        class Dbconnect extends PDO
        {
            ...
            private $dbuser     = 'cornerst_121'; // Set your database username
            private $dbpassword = 'cornerst_121'; //Set your database password
            private $dbname     = 'cornerst_121'; // This can be changed too into yours
